		...
		<div class="clone_div">
			<table>
				...
				<tr>
					<td>纬度：</td>
					<td>
						<input type="text" name="Form[latitude]" value="" id="form_latitude" readonly="true">
					</td>
					<td></td>
				</tr>
				...
				<tr>
					<td>经度：</td>
					<td>
						<input type="text" name="Form[longitude]" value="" id="form_longitude" readonly="true">
					</td>
					<td></td>
				</tr>
				...
				<tr>
					<td>详细地址：</td>
					<td><textarea name="Form[address]" id="form_address"></textarea></td>
					<td></td>
				</tr>
